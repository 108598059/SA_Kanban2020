...
import kanban.domain.adapter.presenter.board.BoardDTOViewModelTransformer;
...
public class GetBoardsPresenter implements GetBoardsOutput {
    ...
    public GetBoardsViewModel build(){
        ...
        for(BoardDTO boardDTO: boardDTOs){
            boardViewModels.add(BoardDTOViewModelTransformer.transformDTOToViewModel(boardDTO));
        }
