...
public class Workflow extends AggregateRoot {
    ...
    public String createStage(String stageName) {
        ...
        addDomainEvent(new StageCreated(stageName, lane.getId(), id));
        return lane.getId();
    }
    ...
    public String createStage(String stageName, String parentLaneId) {
        ...
        addDomainEvent(new StageCreated(stageName, lane.getId(), parentLaneId, id));
        return lane.getId();
    }
    ...
    public String createSwimLane(String swimLaneName, String parentLaneId) {
        ...
        addDomainEvent(new SwimLaneCreated(swimLaneName, lane.getId(), parentLaneId, id));
        return lane.getId();
    }
